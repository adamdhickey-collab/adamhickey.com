...
const CLAIMS = [
  ...
  { doc: 'README.md',
    says: 'Thirty pages in nine families',
    n: 30, what: 'pages', of: () => PAGES.length },

  { doc: 'README.md',
    says: 'The site: 30 pages in nine families',
    n: 30, what: 'pages, as the summary table states them', of: () => PAGES.length },

  { doc: 'README.md',
    says: 'Thirty pages in nine families',
    n: 9, what: 'families in the README table', of: familyTableRows },

  { doc: 'README.md',
    says: 'Thirty pages in nine families',
    n: 30, what: 'pages summed across the family table', of: familyTableSum },

  { doc: 'README.md',
    says: 'which all thirty pages',
    n: 30, what: 'pages loading type.css', of: () => pagesLoading('type.css') },

  { doc: 'README.md',
    says: 'hand-written into all thirty pages',
    n: 30, what: 'pages loading site-nav.css', of: () => pagesLoading('site-nav.css') },
  ...
  { doc: 'design-system/index.html',
    says: 'Thirty pages, and the only edition',
    n: 30, what: 'pages, as the editions list states them', of: () => PAGES.length },
  { doc: 'design-system/index.html',
  ...
  { doc: 'COLOR.md',
    says: 'It is loaded by twenty-four pages',
    n: 24, what: 'pages loading style.css', of: () => pagesLoading('style.css') },

  { doc: 'COLOR.md',
    says: 'token files are loaded by all thirty',
    n: 30, what: 'pages loading color.css', of: () => pagesLoading('color.css') },
];
