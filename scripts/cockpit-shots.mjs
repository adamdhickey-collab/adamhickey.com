 ...
 * cockpit: the fixed header goes, the device bezel goes, and the rail goes.
...
/* Each shot: the situation to load, the viewport that renders it correctly,
   ...
   `click` presses a control and waits for the render that follows. */
const SHOTS = [
  {
    name: 'close-call',
    scenario: 'tie',
...
/* The strip. Everything here is page furniture around the cockpit, or the
   rail, which is the page talking about it. */
const STRIP = [
  ...
  '.ck-rail, .ck-tabs-label, .ck-tabs { display: none !important; }',
  /* The numbered badges belong to the rail, so they go with it. */
